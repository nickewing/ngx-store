...
export class CookiesStorage extends NgxStorage {
  ...
  constructor() {
    ...
    if (Config.cookiesCheckInterval) {
      interval(Config.cookiesCheckInterval).subscribe(() => {
  ...
  public removeItem(key: string): void {
    ...
    document.cookie =
      key + "=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/;" + domain;
  ...
  protected getDomain(): string {
    ...
    document.cookie =
      s + "=;expires=Thu, 01 Jan 1970 00:00:00 GMT;domain=" + domain + ";";
    return domain;
  }
}
